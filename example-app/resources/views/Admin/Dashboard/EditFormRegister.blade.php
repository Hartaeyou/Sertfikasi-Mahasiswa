    ...
    <div class="d-flex justify-content-center">
        <div class="card" style="width: 200vh; height: auto">
            <div class="card-body">
                ...
                <div class="row mt-3">
                    <form action="{{ route('submitUpdateRegister', $register->id) }}" method="post"
                        ...
                        @endif
                        <input type="text" name="user_id" value="{{ $register->id }}" hidden>
                        <div class="mt-2">
                        ...
                        <div class="mt-2">
                            ...
                            <input type="text" class="form-control" id="address_now" name="address_now"
                                aria-describedby="addressHelp" placeholder="address_now"
                                value="{{ $register->address_now }}">
                        </div>
                        <div class="mt-2">
                        ...
                        <div class="mt-2">
                            ...
                            <select name="marital_status" class="form-select" aria-label="Default select example">
                                <option selected>{{ $register->MarriedStatus }}</option>
                        ...
                        <div class="mt-2">
                            ...
                            <select name="religion"class="form-select" aria-label="Default select example">
                                <option selected>{{ $register->religion }}</option>
                        ...
                        <img src="{{ asset('img/'.$register->ktp_file) }}"  width="100px" class="img-fluid mt-2" > 
                        <div class="mt-2">
